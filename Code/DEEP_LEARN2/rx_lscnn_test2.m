function [PSDU_decode_out] = rx_lscnn_test2(rx_ofdm_data,symbol_num,Pilot_method,VCNum_method,Np,loc_pilot,phase,N_FFT,ValidCarrierNum,PSDU_BPC,wlanSymMap,PadBits_Num,PSDU_PB)   
