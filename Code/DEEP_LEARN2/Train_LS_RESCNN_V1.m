function [Train_out, Train_Info] = Train_LS_RESCNN_V1(Train_data, Train_label, Valid_data, Valid_label)
...
% plot(lgraph);
    ...
    [Train_out, Train_Info] = trainNetwork(train_datas1, train_labels1, lgraph, Options);
