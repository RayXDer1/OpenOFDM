function [rx_ofdm_data,rx_pofdm_data,synchron_local,synchron_proba,MSE_cfo] = rx_test1(synchron_local,synchron_proba,MSE_cfo,rx_signal,rx_perfect_signal,CarrierNUM,symbol_num,N_FFT,N_CP,Nsym_CP,cfo_offset,Fs,n)
